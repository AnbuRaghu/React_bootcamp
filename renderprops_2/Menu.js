...
// there are bunch of way to make use of render props eg:instead of MENU RENDERING MY Toggler , I could potentially import the toggler in APP and i could wrap the toggle around menu
function Menu(props) {
    return (
